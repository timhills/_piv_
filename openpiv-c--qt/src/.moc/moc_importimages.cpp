...
struct qt_meta_stringdata_ImportImages_t {
    QByteArrayData data[7];
    char stringdata0[80];
};
#define QT_MOC_LITERAL(idx, ofs, len) \
    Q_STATIC_BYTE_ARRAY_DATA_HEADER_INITIALIZER_WITH_OFFSET(len, \
    qptrdiff(offsetof(qt_meta_stringdata_ImportImages_t, stringdata0) + ofs \
        - idx * sizeof(QByteArrayData)) \
    )
static const qt_meta_stringdata_ImportImages_t qt_meta_stringdata_ImportImages = {
    {
QT_MOC_LITERAL(0, 0, 12), // "ImportImages"
QT_MOC_LITERAL(1, 13, 14), // "imagesImported"
QT_MOC_LITERAL(2, 28, 0), // ""
QT_MOC_LITERAL(3, 29, 11), // "removeFiles"
QT_MOC_LITERAL(4, 41, 10), // "QList<int>"
QT_MOC_LITERAL(5, 52, 13), // "importPressed"
QT_MOC_LITERAL(6, 66, 13) // "cancelPressed"

    },
    "ImportImages\0imagesImported\0\0removeFiles\0"
    "QList<int>\0importPressed\0cancelPressed"
};
...
void ImportImages::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        {
            typedef void (ImportImages::*_t)();
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ImportImages::imagesImported)) {
                *result = 0;
                return;
            }
        }
...
const QMetaObject ImportImages::staticMetaObject = {
    { &QDialog::staticMetaObject, qt_meta_stringdata_ImportImages.data,
      qt_meta_data_ImportImages,  qt_static_metacall, Q_NULLPTR, Q_NULLPTR}
};
...
void *ImportImages::qt_metacast(const char *_clname)
{
    ...
    if (!strcmp(_clname, qt_meta_stringdata_ImportImages.stringdata0))
